...
-- ORDER BY
SELECT * FROM CUSTOMER ORDER BY Name, Age 

SELECT * FROM CUSTOMER ORDER BY Age,Name
 
SELECT * FROM CUSTOMER ORDER BY Name desc

SELECT * FROM CUSTOMER WHERE Name<>'Rahim'
...
-- Value ends with ka and anything in the beginning 
SELECT * FROM CUSTOMER WHERE NAME LIKE '%Ka'
--For the value where ka is present anywhere in the data 
SELECT * FROM CUSTOMER WHERE NAME LIKE '%Ka%'
SELECT * FROM CUSTOMER WHERE NAME LIKE '___K'
-- For 3 characters in beginning and then k and then anything else 
SELECT * FROM CUSTOMER WHERE NAME LIKE '___K%'
-- For atleast 1 character
SELECT * FROM CUSTOMER WHERE NAME LIKE '%_%'
-----
SELECT * FROM CUSTOMER WHERE NAME LIKE 'k____%'

SELECT Name,Salary*12 FROM CUSTOMER
--IN
...
SELECT COUNT(Distinct Address) as NumberOfCustomers FROM CUSTOMER 
...
SELECT Age, MAX(Salary) FROM CUSTOMER GROUP BY Age ORDER BY age; 
Select COUNT(Salary), Max(Age) FROM CUSTOMER
